...
Route work to the authority that owns the outcome.

## Procedure

1. Read `AGENTS.md`, `docs/architecture.md`, `docs/work-lifecycle.md`, affected
   paths, and relevant live Issues or PRs. Complete when the requested behavior
   and existing overlap are known.
2. Select one primary owner:
   - Aldunis Code: local repositories, worktrees, provider sessions,
     conversations, approvals, and diffs;
...
4. Draft one observable outcome with non-goals, acceptance evidence, risks, and
   fully qualified dependencies. Do not publish unless authorized.
